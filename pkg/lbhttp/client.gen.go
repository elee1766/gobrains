// Package lbhttp provides primitives to interact with the openapi HTTP API.
//
...
type LookupMetadataTag struct {
	...
	ReleaseGroup *[]TopReleaseGroupsForArtistInnerTagReleaseGroupInner `json:"release_group,omitempty"`
}
...
type RecordingMetadataTag struct {
	Artist       *[]TopReleaseGroupsForArtistInnerTagArtistInner       `json:"artist,omitempty"`
	Recording    *[]TopReleaseGroupsForArtistInnerTagReleaseGroupInner `json:"recording,omitempty"`
	ReleaseGroup *[]TopReleaseGroupsForArtistInnerTagReleaseGroupInner `json:"release_group,omitempty"`
}
...
// TopReleaseGroupsForArtistInnerTagReleaseGroupInner defines model for topReleaseGroupsForArtist_inner_tag_release_group_inner.
type TopReleaseGroupsForArtistInnerTagReleaseGroupInner struct {
	Count     *int                `json:"count,omitempty"`
	GenreMbid *openapi_types.UUID `json:"genre_mbid,omitempty"`
	Tag       *string             `json:"tag,omitempty"`
}
